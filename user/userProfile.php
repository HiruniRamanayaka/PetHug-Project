<?php
   ...
   $user_id = $_SESSION['user_id']; // Assign doctor_id from session before using it in query
    ...
    if (isset($_POST["update"])) {
        ...
        if (empty($user_first_name) || empty($user_last_name) || empty($user_email) || empty($user_phone) || empty($user_address)) {
            ...
            $sql = "UPDATE user SET user_name='$user_name', user_email='$user_email', user_phone='$user_phone' WHERE user_id='$user_id'";
        ...
        // Redirect to user_profile.php if cancel is clicked
        header("Location: user_profile.php");
        exit();
    }
    ...
    <div class="profile-container">
        ...
        <div class="form">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                ...
                <input id="name" type="text" name="user_first_name" value="<?php echo htmlspecialchars($row['user_first_name']);?>"><br><br>
                <label for="name">Name:</label>
                <input id="name" type="text" name="user_last_name" value="<?php echo htmlspecialchars($row['user_last_name']);?>"><br><br>
