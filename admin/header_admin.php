    ...
    <header class="header">
        ...
        <nav class="nav-bar">
            ...
            <ul class="nav-links">
                ...
                <li><a href="admin_consultation_management.php" class="<?php if($current_page == 'admin_consultation_management.php'){echo 'active';} ?>">Consultation <br> Management</a></li>
                <li><a href="admin_appointment_management.php" class="<?php if($current_page == 'admin_appointment_management.php'){echo 'active';} ?>">Appointment <br> Management</a></li>
