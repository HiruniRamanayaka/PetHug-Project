...
<head>
    ...
    <link rel="stylesheet" href="../afterLoginUser_style/footer.css" type="text/css">
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-section contact-us">
                <h4>Contact Us</h4>
                <p><i class="fa fa-map-marker-alt"></i>&nbsp;&nbsp;123 Pet Lane, Animal City, PA 12345</p>
            ...
            <div class="footer-section quick-links">
                ...
                <ul>
                    ...
                    <li><a href="admin_consultation_management.php">Consultation Management</a></li>
                    <li><a href="admin_appointment_management.php">Appointment Management</a></li>
                    <li><a href="admin_user_management.phpp">User Management</a></li>
                    <li><a href="admin_doctor_management.php">Doctor Management</a></li>
